package com.yg0r2.kinesis.client.example.berqfs.rest;
...
import com.yg0r2.kinesis.client.example.berqfs.domain.ServiceCallContext;
...
@RestController
public class FastLaneProducerRestController {

    private static final Logger LOGGER  = LoggerFactory.getLogger(FastLaneProducerRestController.class);
