...
abstract class AbstractKinesisRecordProducer<T> implements RecordProducer<T> {
    ...
    public AbstractKinesisRecordProducer(String streamName, KinesisProducer kinesisProducer) {
